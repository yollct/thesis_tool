...
n16h = pd.read_csv("/nfs/home/students/chit/Thesis/results/{}/cluster_table.csv".format(data))
want = n16h['cluster']=="Cluster {}".format(cluster)

filter = n16h[want]
filter.to_csv("/nfs/home/students/chit/Thesis/results/{}/clust{}.csv".format(data,cluster))
